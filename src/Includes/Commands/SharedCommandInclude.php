...
#[Purpose('Shared baseline rules for all commands except specialized subcommands. Provides tag taxonomy, error handling, failure policy, git protections, and zero-exfiltration safety.')]
class SharedCommandInclude extends IncludeArchetype
{
