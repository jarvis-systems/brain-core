...
/**
 * Extract attributes for Includes.
 * Maps #[Purpose] → provides() method for <provides> tag rendering.
 */
trait ExtractIncludeAttributesTrait
{
    ...
    protected function extractAttributes(): void
    {
        ...
        // Includes: #[Purpose] → provides() → <provides> tag
